...
/**
 * Add event listener em todos os componentes
 * @param {NodeList} elements Array de elementos node
 * @param {string} eventType  Evento do tipo e.g.: "click", "mouseover"
...
/**
 * Toggle search em dispositivos mobile
 */
...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    <ul class="meta-list">
        ...
        <li class="meta-item">
            <span class="material-symbols-outlined h-icon">
                calendar_today
            </span>
      ...
      <div class="highlight-list">
        ...
        module.aqiText[aqi].message
          ...
          <div class="card card-sm highlight-card two">
              <h3 class="title-3">Nascer & Pôr do Sol</h3>
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
       ...
       */
      forecastSection.innerHTML = `
        <h2 class="title2">Previsão para 5 dias</h2>
